...
var MONGODB_OLIVE_URI = process.env.MONGODB_OLIVE_URI || "mongodb://localhost/mongoHeadlines";
mongoose.connect(MONGODB_OLIVE_URI);
...
app.post("/articles/:id", function(req, res) {
    // TODO: Make save not true all the time.
